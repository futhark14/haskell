...
data FamilyTree = Void | Woman String Int FamilyTree  FamilyTree  | Man String Int FamilyTree FamilyTree deriving (Show,Eq)

compareMaybe :: Maybe (String, Int) -> Maybe (String, Int) -> Maybe (String, Int)
comparMaybe Nothing y = y
compareMaybe  
...
data MetaPrisBild = Void | Telefon String Int MetaPrisBild MetaPrisBild

appletelefon :: MetaPrisBild -> (String Int)
            appletelefon
          /               \
  ("iphone 12", 9000)     ("iphone x", 5000)
