...
/* package pkdproject-0.1.0.0 */
#ifndef VERSION_pkdproject
#define VERSION_pkdproject "0.1.0.0"
#endif /* VERSION_pkdproject */
#ifndef MIN_VERSION_pkdproject
#define MIN_VERSION_pkdproject(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_pkdproject */
...
#define CURRENT_COMPONENT_ID "pkdproject-0.1.0.0-inplace-pkdproject"
